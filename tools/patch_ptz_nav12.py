...
# Insert wheel arbitration before the legacy zoom/home button event loop.
marker = """        for (const [startEvent, endEvent] of [['touchstart','touchend'],['mousedown','mouseup']]) {\n"""
...
assert marker in s, 'zoom/home event loop marker not found'
